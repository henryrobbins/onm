...
class AmexCsvConnection(Connection):
    ...
    def sync_transactions(self, sync_cursor: Optional[CsvSyncCursor] = None) -> SyncTransactionsResponse:
        ...
        return SyncTransactionsResponse(
            ...
            sync_cursor=CsvSyncCursor(latest_transaction_date=latest_transaction_date.isoformat())
        )
